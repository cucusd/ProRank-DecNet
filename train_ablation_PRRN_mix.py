...
import random
import os
from test_code import main as test_function
...
def main(config):
    ...
    if args.model_name == 'resnet50':
        model = AutoModelForImageClassification.from_pretrained(
            ...
            trust_remote_code=args.trust_remote_code,num_labels1=args.num_labels, num_labels2=args.num_labels_sub,use_diff= True
        )
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(model):
                ...
                sorter = diffsort.DiffSortNet(
                    sorting_network_type='bitonic',  # sort method:bitonic,odd_even
                ...
                loss =  loss1 +  loss2 + 0.5 * loss_diff # 显式加权
        ...
        if accuracy2 > best_accuracy_sub:
            ...
            if accelerator.is_main_process:
                ...
                logger.info(f"New best SUB model saved with accuracy: {best_accuracy_sub:.4f}")
        ...
        if accuracy1 > best_accuracy_ori:
            ...
            if accelerator.is_main_process:
                ...
                logger.info(f"New best ORI model saved with accuracy: {best_accuracy_ori:.4f}")
        ...
        if composite_score > best_accuracy:
            ...
            if accelerator.is_main_process:
                ...
                logger.info(f"New best COMPOSITE model saved with score: {best_accuracy:.4f}")
...
if __name__ == '__main__':
    ...
    for jj in range(len(model_name)):
        ...
        for i in [0.3]:
            ...
            args.output_dir = f'output/shanxi_train_old_data_Stage1x3_param_PRRN_mix/{args.model_name}' + '_steepness'+str(args.art_lambda)
            main(args)
